...
const Navbar = () => {
    ...
    let gadgetPrice=0;
    myGadgets.map(gadget=>gadgetPrice+=gadget.price);
                ...
                <div className="dropdown dropdown-end">
                    ...
                    <div
                        ...
                        <div className="card-body">
                            <span className="text-lg font-bold">{storedGadgets.length} Items</span>
                            <span className="text-info">Subtotal: {gadgetPrice}Tk</span>
